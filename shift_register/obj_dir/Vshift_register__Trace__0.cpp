...
void Vshift_register___024root__trace_chg_sub_0(Vshift_register___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vshift_register___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshift_register___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vshift_register___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vshift_register___024root__trace_chg_sub_0(Vshift_register___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vshift_register__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vshift_register___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    bufp->chgBit(oldp+0,(vlSelf->clk));
    bufp->chgCData(oldp+1,(vlSelf->mode),3);
    bufp->chgCData(oldp+2,(vlSelf->D),8);
    bufp->chgBit(oldp+3,(vlSelf->serial_in));
    bufp->chgCData(oldp+4,(vlSelf->Q),8);
}
