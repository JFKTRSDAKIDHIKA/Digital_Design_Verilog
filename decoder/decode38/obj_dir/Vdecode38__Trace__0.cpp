...
void Vdecode38___024root__trace_chg_sub_0(Vdecode38___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vdecode38___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode38___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    Vdecode38___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void Vdecode38___024root__trace_chg_sub_0(Vdecode38___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    Vdecode38__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vdecode38___024root__trace_chg_sub_0\n"); );
    // Init
    ...
    bufp->chgIData(oldp+3,(vlSelf->decode38__DOT__i),32);
}
