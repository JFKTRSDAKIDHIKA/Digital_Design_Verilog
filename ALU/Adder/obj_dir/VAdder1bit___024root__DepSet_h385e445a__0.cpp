...
VL_INLINE_OPT void VAdder1bit___024root___ico_sequent__TOP__0(VAdder1bit___024root* vlSelf) {
    ...
    vlSelf->Suber4bits__DOT____Vcellinp__adders__BRA__2__KET____DOT__u__Cin 
        = (1U & ((((~ ((IData)(vlSelf->B) >> 1U)) | 
                   ((IData)(vlSelf->A) >> 1U)) & (IData)(vlSelf->Suber4bits__DOT____Vcellinp__adders__BRA__1__KET____DOT__u__Cin)) 
                 | ((~ ((IData)(vlSelf->B) >> 1U)) 
                    & ((IData)(vlSelf->A) >> 1U))));
    vlSelf->Suber4bits__DOT____Vcellinp__adders__BRA__3__KET____DOT__u__Cin 
        = (1U & ((((~ ((IData)(vlSelf->B) >> 2U)) | 
                   ((IData)(vlSelf->A) >> 2U)) & (IData)(vlSelf->Suber4bits__DOT____Vcellinp__adders__BRA__2__KET____DOT__u__Cin)) 
                 | ((~ ((IData)(vlSelf->B) >> 2U)) 
                    & ((IData)(vlSelf->A) >> 2U))));
    vlSelf->Cout = (1U & ((((~ ((IData)(vlSelf->B) 
                                >> 3U)) | ((IData)(vlSelf->A) 
                                           >> 3U)) 
