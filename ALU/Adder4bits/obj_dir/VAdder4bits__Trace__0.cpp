...
void VAdder4bits___024root__trace_chg_sub_0(VAdder4bits___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void VAdder4bits___024root__trace_chg_top_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAdder4bits___024root__trace_chg_top_0\n"); );
    // Init
    ...
    // Body
    VAdder4bits___024root__trace_chg_sub_0((&vlSymsp->TOP), bufp);
}

void VAdder4bits___024root__trace_chg_sub_0(VAdder4bits___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    if (false && vlSelf) {}  // Prevent unused
    VAdder4bits__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAdder4bits___024root__trace_chg_sub_0\n"); );
    // Init
    uint32_t* const oldp VL_ATTR_UNUSED = bufp->oldp(vlSymsp->__Vm_baseCode + 1);
    // Body
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgBit(oldp+0,(vlSelf->Adder4bits__DOT____Vcellinp__adders__BRA__1__KET____DOT__u__Cin));
        bufp->chgBit(oldp+1,(vlSelf->Adder4bits__DOT____Vcellinp__adders__BRA__2__KET____DOT__u__Cin));
        bufp->chgBit(oldp+2,(vlSelf->Adder4bits__DOT____Vcellinp__adders__BRA__3__KET____DOT__u__Cin));
    }
    ...
    bufp->chgCData(oldp+7,((((IData)(vlSelf->Cout) 
                             << 4U) | (((IData)(vlSelf->Adder4bits__DOT____Vcellinp__adders__BRA__3__KET____DOT__u__Cin) 
                                        << 3U) | (((IData)(vlSelf->Adder4bits__DOT____Vcellinp__adders__BRA__2__KET____DOT__u__Cin) 
                                                   << 2U) 
    ...
    bufp->chgBit(oldp+18,((1U & ((IData)(vlSelf->B) 
                                 >> 3U))));
    bufp->chgBit(oldp+19,((IData)(((((IData)(vlSelf->A) 
...
void VAdder4bits___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VAdder4bits___024root__trace_cleanup\n"); );
    // Init
    VAdder4bits___024root* const __restrict vlSelf VL_ATTR_UNUSED = static_cast<VAdder4bits___024root*>(voidSelf);
    VAdder4bits__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    // Body
